...
In addition, EssentialsX's optional modules provide further integrated features like chat formatting, world protection, GeoIP lookup and more - see the [Module-Breakdown](https://essentialsx.net/wiki/Module-Breakdown.html) for more information.

## Pages

* [BannerMeta](https://essentialsx.net/wiki/BannerMeta.html)
* [Command-Cooldowns](https://essentialsx.net/wiki/Command-Cooldowns.html)
* [Color-Permisions](https://essentialsx.net/wiki/Color-Permissions.html)
...
EssentialsX is a fork of the original [Essentials project](https://github.com/essentials/Essentials), which was discontinued in 2014. EssentialsX adds several new features over the original Essentials - [Improvements](https://essentialsx.net/wiki/Improvements.html), and [EssentialsX changelogs](https://github.com/EssentialsX/Essentials/releases) for more information.
